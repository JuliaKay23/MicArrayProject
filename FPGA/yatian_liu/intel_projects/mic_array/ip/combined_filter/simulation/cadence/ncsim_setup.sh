...
TOP_LEVEL_NAME="combined_filter"
QSYS_SIMDIR="./../"
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/combined_filter_avalon_st_adapter_timing_adapter_0.sv" -work timing_adapter_0  -cdslib ./cds_libs/timing_adapter_0.cds.lib 
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/combined_filter_avalon_st_adapter.v"                   -work avalon_st_adapter -cdslib ./cds_libs/avalon_st_adapter.cds.lib
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/combined_filter_fir_compiler_ii_0_rtl_core.vhd"        -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/combined_filter_fir_compiler_ii_0_ast.vhd"             -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/combined_filter_fir_compiler_ii_0.vhd"                 -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/combined_filter_fir_compiler_ii_0_tb.vhd"              -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/combined_filter_cic_ii_0.sv"                           -work cic_ii_0          -cdslib ./cds_libs/cic_ii_0.cds.lib         
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/combined_filter.v"                                                                                                                    
fi
