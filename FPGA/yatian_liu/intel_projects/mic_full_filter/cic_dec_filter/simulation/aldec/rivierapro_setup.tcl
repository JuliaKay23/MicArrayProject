...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "cic_dec_filter"
}
...
alias com {
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/cic_dec_filter_cic_ii_0.sv"                      -work cic_ii_0
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/cic_dec_filter.v"                                                         
}
