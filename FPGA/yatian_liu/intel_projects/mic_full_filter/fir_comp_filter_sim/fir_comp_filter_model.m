...
% ================================================================================
% Generated on: 07/22/2020 01:27:03
...
for j = 1:sx
    ...
    %
    file_name = ['fir_comp_filter_input.txt'];
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = fir_comp_filter_mlab(single_channel_data{i}, single_channel_bank{i});
  ...
  for j = 1: limit;
    ...
    file_name = ['fir_comp_filter_model_output'];
