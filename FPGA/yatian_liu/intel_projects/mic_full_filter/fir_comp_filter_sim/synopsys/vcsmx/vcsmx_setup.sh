...
# ACDS 19.1 670 win32 2020.07.22.01:27:04
...
# ----------------------------------------
# If fir_comp_filter is one of several IP cores in your
...
TOP_LEVEL_NAME="fir_comp_filter"
QSYS_SIMDIR="./../../"
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/fir_comp_filter_rtl_core.vhd"                   
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/fir_comp_filter_ast.vhd"                        
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/fir_comp_filter.vhd"                            
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/fir_comp_filter_tb.vhd"                         
fi
